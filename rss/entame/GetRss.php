...
$pages = array(
	...
	"01" => array(
		"title" => "Yahoo!ニュース・トピックス - エンタメ",
		"rss"   => "https://news.yahoo.co.jp/pickup/entertainment/rss.xml",
		"body"  => array(
			"start_word" => "",
			"end_word"   => "",
			"end_tag"    => ""
	...
	"02" => array(
		...
		"url"   => "https://news.nifty.com/rss/topics_entame.xml",
		"body"  => array(
			"start_word" => "",
			"end_word"   => "",
			"end_tag"    => ""
	...
	"03" => array(
		"title" => "毎日新聞 「エンタメ」RSS",
		"url"   => "http://rss.rssad.jp/rss/mainichi/enta.rss",
		"body"  => array(
			"start_word" => "",
			"end_word"   => "",
			"end_tag"    => ""
	...
	"04" => array(
		"title" => "NHKニュース|文化・エンタメ",
		"url"   => "http://www3.nhk.or.jp/rss/news/cat2.xml",
		"body"  => array(
			"start_word" => "",
			"end_word"   => "",
			"end_tag"    => ""
	...
	"05" => array(
		"title" => "エンタメ注目のニュース - gooニュース",
		"url"   => "https://news.goo.ne.jp/rss/topstories/entertainment/",
		"body"  => array(
			"start_word" => "",
			"end_word"   => "",
			"end_tag"    => ""
