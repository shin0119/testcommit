...
$pages = array(
	...
	"01" => array(
		"title" => "Yahoo!ニュース・トピックス - スポーツ",
		"rss"   => "https://news.yahoo.co.jp/pickup/sports/rss.xml",
		"body"  => array(
			"start_word" => "",
			"end_word"   => "",
			"end_tag"    => ""
	...
	"02" => array(
		"title" => "「スポーツ総合」の最新ニュース - SANSPO.COM（サンスポ・コム）",
		"url"   => "http://rss.rssad.jp/rss/sanspo/chumoku/news/allsports-n.xml?rss",
		"body"  => array(
			"start_word" => "",
			"end_word"   => "",
			"end_tag"    => ""
	...
	"03" => array(
		"title" => "NHKニュース|スポーツ",
		"url"   => "http://www3.nhk.or.jp/rss/news/cat7.xml",
		"body"  => array(
			"start_word" => "",
			"end_word"   => "",
			"end_tag"    => ""
	...
	"05" => array(
		"title" => "スポーツ - 朝日新聞デジタル",
		"url"   => "http://rss.asahi.com/rss/asahi/sports.rdf",
		"body"  => array(
			"start_word" => "",
			"end_word"   => "",
			"end_tag"    => ""
